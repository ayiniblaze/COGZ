// Direct test using TypeScript evaluation
...
if (r1.errors.length > 0) {
  console.log('Error:', r1.errors[0].message);
}
console.log('');
...
console.log('Success:', r2.successMessage);
console.log('');
...
if (r3.errors.length > 0) {
  console.log('Error:', r3.errors[0].message);
}
console.log('');
...
console.log('Success:', r4.successMessage);
console.log('');
...
if (r5.errors.length > 0) {
  console.log('Error:', r5.errors[0].message);
}
console.log('');
...
if (r6.errors.length > 0) {
  console.log('Error:', r6.errors[0].message);
}
